...
TRAINING_DATA_PREFIX = "island-data-bottle-round-3"
...
def simulate_alternative(round: int, day: int, trader, print_position=False, time_limit=999900, end_liquidation=True):
    prices_path = f"island-data-bottle-round-3/prices_round_{round}_day_{day}.csv"
    trades_path = f"island-data-bottle-round-3/trades_round_{round}_day_{day}_nn.csv"
...
if __name__ == "__main__":
    trader = Trader()
    simulate_alternative(3, 0, trader, True, 999900)
    # simulate_alternative(3, 1, trader, True, 999900)
    # simulate_alternative(3, 2, trader, True, 999900)
